...
if(filter_input(INPUT_SERVER, 'REQUEST_METHOD', FILTER_SANITIZE_STRING) === "POST") {
    ...
    $email = $link->real_escape_string(filter_input(INPUT_POST,'email',FILTER_SANITIZE_STRING));
    //prepare and execute
    $sql_str = "SELECT user_id, is_active, reg_date, last_login, user_type, user_name, email FROM user WHERE user_name = ? AND email = ?";
